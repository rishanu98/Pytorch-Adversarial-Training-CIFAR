...
class SaveMetricsCallback:
    def __init__(self, filename):
        ...
        with open(self.filename,"w") as file:
            file.write=("ADV_Train_Accuracy,Adv_Train_Loss,Benign_Test_Accuracy,Adv_test_Accuracy,Adv_Test_Loss\n")
    
    def __call__(self,epoch,net,trainloader,testloader,optim,criterion):
        ...
        def train(epoch):
            ...
            print('\nTotal adversarial train accuarcy:', Acc)
    ...
    with open(self.filename, 'a') as file:
        file.write(f"{Acc},{train}{},{loss.item}")
...
save_metric_callback = SaveMetricsCallback("Result.csv")

for epoch in range(0, 200):
    adjust_learning_rate(optimizer, epoch)
    save_metric_callback(epoch,net,train_loader,test_loader,optimizer,criterion)
